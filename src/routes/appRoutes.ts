...
export const SHOP_ROUTES: AppRoute[] = [
  ...
  {
    path: "pos",
    element: lazy(() => import("../pages/shops/pos/BillingPage")),
    resource: "shops",
    action: "view",
    label: "POS",
    showInMenu: true,
  ...
  {
    path: "customers",
    element: lazy(() => import("../pages/shops/customers/Customers")),
    resource: "shops",
    action: "view",
    label: "Customers",
    showInMenu: true,
  },
  {
    ...
    element: lazy(() => import("../pages/shops/customers/NewCustomer")),
    resource: "shops",
    action: "view",
    label: "Customers",
    showInMenu: true,
  ...
  {
    path: "inventory",
    element: lazy(() => import("../pages/shops/inventory/index")),
    resource: "shops",
    action: "view",
    label: "Inventory",
    showInMenu: true,
  ...
  {
    path: "settings",
    element: lazy(() => import("../pages/shops/settings/Settings")),
    resource: "shops",
    action: "view",
    label: "Settings",
    showInMenu: true,
